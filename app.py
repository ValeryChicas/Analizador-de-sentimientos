...
#
# Se utilizó CSS personalizado (vía st.markdown) para aplicar el diseño de interfaz en modo oscuro responsive,
# mientras que Python, TextBlob y Deep-Translator ejecutan internamente toda la lógica del análisis.
